...
from module.stftVQVAE import VQVAE
...
class AudioVQVAE_lightning(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('rec', loss, on_step=True, on_epoch=False, prog_bar=True, logger=True)
    ...
    def on_train_epoch_end(self):
        ...
        wav = self.pad_wav(wav.unsqueeze(1), 1280).squeeze(1)
